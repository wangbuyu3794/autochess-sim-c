...
当前处于 `V1.20 Equipment Fit AI` 阶段，已经支持交互式准备、基础手动站位、运营经济命令、商店锁定、多费用商店概率、扩展英雄池、羁绊展示、完整的第一版羁绊战斗效果、基础战斗属性、更丰富的表驱动技能、更清晰的战斗日志、基础状态效果、更灵活的技能目标规则、第一版装备系统、回合装备奖励、自动装备、手动卸装和装备适配评分。
