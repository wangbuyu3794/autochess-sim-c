...
static const HeroTemplate HERO_TEMPLATES[] = {
    ...
    {HERO_RUNE_MAGE, "符法", 3, 105, 40, 6, 18, 8, 150, 3, 20, 80, SKILL_FIREBALL, TRAIT_MAGE, TRAIT_CITY},
    {HERO_DAWN_GUARDIAN, "曦盾", 4, 190, 28, 28, 18, 5, 150, 1, 20, 90, SKILL_IRON_SHIELD, TRAIT_GUARDIAN, TRAIT_FOREST},
    {HERO_NIGHT_ASSASSIN, "夜刺", 4, 150, 48, 12, 10, 25, 170, 1, 30, 80, SKILL_POWER_STRIKE, TRAIT_BLADEMASTER, TRAIT_SHADOW},
};
